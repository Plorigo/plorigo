...
func TestAuthorizeMatrix(t *testing.T) {
	cases := []struct {
		...
		{authz.RoleMember, authz.ActionConfigSet, true},
		{authz.RoleMember, authz.ActionConfigDelete, true},
		{authz.RoleViewer, authz.ActionConfigRead, true},
		{authz.RoleViewer, authz.ActionConfigSet, false},
		{authz.RoleMember, authz.ActionDomainCreate, true},
		{authz.RoleMember, authz.ActionDomainVerify, true},
		{authz.RoleViewer, authz.ActionDomainRead, true},
		{authz.RoleViewer, authz.ActionDomainCreate, false},
	}
	for _, c := range cases {
